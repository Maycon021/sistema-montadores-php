...
$pdo = $conn->query("SELECT * FROM pagamento ");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="assets/action_pagamento.php">
        	 <div class="form-group">
    <label for="exampleInputEmail1">Forma Pagamento</label>
    <input type="text" class="form-control"  name="pagamento" placeholder="Digite uma forma de pagamento">
