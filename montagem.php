...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
	...
	<title>CADASTRO DE Montagem</title>
...
<div class="container pt-5">
    <h1> Agendamento de Montagem</h1><br>  
  ...
  <tbody>
    <tr>
          ...
          <td><?= $resultado['horas']  ?></td>
           <td><i><i style="font-size: 12px;" class=" bg-primary  p-1 text-white fa-solid fa-pen-to-square"></i></i> <i  style="font-size: 12px;"  class=" bg-danger  p-1 text-white fa-solid fa-trash"></i></td>
