...
$pdo = $conn->query("SELECT * FROM montadores where nome='$pesq_nome' ");
$result = $pdo->fetchAll();
...
$pdo = $conn->query("SELECT * FROM montadores ");
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
	...
	<title>CADASTRO DE MONTADORES</title>
...
<div class="modal" tabindex="-1" role="dialog"  id="cadastrar">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Cadastrar Montador</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form method="POST" action="assets/action_montador.php">
  ...
  <div class="form-group">
    <label >Funcao</label>
    <input type="text" class="form-control"   name="funcao" placeholder="Digite a funcao">
