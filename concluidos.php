...
<p  class="h2 text-success">Total: R$ 
      <?php 
     ...
     <?php   $pdo = $conn->query("SELECT SUM(total) as soma FROM montagem WHERE situacao='Concluido' AND data_montagem = '$data'  ");  
    ...
    <?php   $pdo = $conn->query("SELECT SUM(total) as soma FROM montagem WHERE situacao='Concluido' AND data_montagem = CURDATE()  ");  
	...
	<div class="float-right mb-5" >
      ...
      <input class="form-control text-success  mr-sm-2" type="date" placeholder="Pesquisar nome" aria-label="Search" name="data">
  ...
  <tbody>
    <tr>
          ...
          <td class="text-success"><?= $resultado['situacao']  ?></td>
